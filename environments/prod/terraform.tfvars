...
vnets = {
  vnet1 = {
    name                = "vnet-new-prod"
    location            = "westus"
    resource_group_name = "rg-new-prod"
...
subnets = {
  snet1 = {
    ...
    resource_group_name  = "rg-new-prod"
    virtual_network_name = "vnet-new-prod"
...
vms = {
  frontend_1 = {
    ...
    nic_vnet_name   = "vnet-new-prod"
    vm_name         = "frontend-vm-1-prod"
    vm_size         = "Standard_B1s"
    admin_username  = "devopsadmin"
    key_vault_name  = "kv-new-prod-123"
