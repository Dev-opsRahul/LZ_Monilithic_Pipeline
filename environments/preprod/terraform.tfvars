...
vnets = {
  vnet1 = {
    name                = "vnet-new-dev"
    location            = "centralindia"
    resource_group_name = "rg-new-dev"
...
subnets = {
  snet1 = {
    ...
    resource_group_name  = "rg-new-dev"
    virtual_network_name = "vnet-new-dev"
...
vms = {
  frontend_1 = {
    ...
    nic_vnet_name   = "vnet-new-dev"
    vm_name         = "frontend-vm-1-dev"
    vm_size         = "Standard_B1s"
    admin_username  = "devopsadmin"
    key_vault_name  = "kv-new-dev-123"
